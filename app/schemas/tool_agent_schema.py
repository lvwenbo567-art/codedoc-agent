...
class StrictToolAgentModel(BaseModel):
    model_config = ConfigDict(extra="forbid")


class ToolAgentRequest(StrictToolAgentModel):
    ...
    recursion_limit: int = Field(default=30, ge=5, le=100)
...
class ToolAgentResponse(StrictToolAgentModel):
    query: str
    project_id: int
    answer: str
    success: bool
