...
class StrictPersistentAgentModel(BaseModel):
...
class PersistentAgentRequest(StrictPersistentAgentModel):
    ...
    recursion_limit: int = Field(default=30, ge=8, le=100)
...
class PersistentAgentResponse(StrictPersistentAgentModel):
    query: str
    project_id: int
    thread_id: str
...
class ThreadStateResponse(StrictPersistentAgentModel):
    exists: bool
    project_id: int
    thread_id: str
    effective_thread_id: str
...
class ThreadHistoryResponse(StrictPersistentAgentModel):
    project_id: int
    thread_id: str
    count: int
...
class DeleteThreadResponse(StrictPersistentAgentModel):
    deleted: bool
    project_id: int
    thread_id: str
    effective_thread_id: str
